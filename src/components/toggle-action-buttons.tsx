...
export const TOGGLE_THEMES = {
  green: {
    ...
    rowActive: "[--highlight-bg:color-mix(in_srgb,var(--color-green-500)_5%,var(--table-bg,var(--background)))] [--highlight-bg-hover:color-mix(in_srgb,var(--color-green-500)_10%,var(--table-bg,var(--background)))] [--highlight-accent:var(--color-green-500)] shadow-[inset_2px_0_0_0_var(--color-green-500)] bg-green-500/5 hover:bg-green-500/10 transition-colors",
  },
  red: {
    ...
    rowActive: "[--highlight-bg:color-mix(in_srgb,var(--color-red-500)_5%,var(--table-bg,var(--background)))] [--highlight-bg-hover:color-mix(in_srgb,var(--color-red-500)_10%,var(--table-bg,var(--background)))] [--highlight-accent:var(--color-red-500)] shadow-[inset_2px_0_0_0_var(--color-red-500)] bg-red-500/5 hover:bg-red-500/10 transition-colors",
  },
  blue: {
    ...
    rowActive: "[--highlight-bg:color-mix(in_srgb,var(--color-blue-500)_5%,var(--table-bg,var(--background)))] [--highlight-bg-hover:color-mix(in_srgb,var(--color-blue-500)_10%,var(--table-bg,var(--background)))] [--highlight-accent:var(--color-blue-500)] shadow-[inset_2px_0_0_0_var(--color-blue-500)] bg-blue-500/5 hover:bg-blue-500/10 transition-colors",
  },
  amber: {
    ...
    rowActive: "[--highlight-bg:color-mix(in_srgb,var(--color-amber-500)_5%,var(--table-bg,var(--background)))] [--highlight-bg-hover:color-mix(in_srgb,var(--color-amber-500)_10%,var(--table-bg,var(--background)))] [--highlight-accent:var(--color-amber-500)] shadow-[inset_2px_0_0_0_var(--color-amber-500)] bg-amber-500/5 hover:bg-amber-500/10 transition-colors",
  },
} as const
